...
public class MainFrameController {
    ...
    private void addGrowthRecordMenus(List<Map> menuList) {
        String role = AppStore.getJwt() == null ? "" : AppStore.getJwt().getRole();
        Map<String, Object> growthMenu = ensureRootMenu(menuList, 7, "成长档案");
        ensureChildMenu(growthMenu, 71, "innovation-practice-panel", "创新实践信息", role,
                "ROLE_ADMIN", "ROLE_STUDENT", "ROLE_TEACHER");
        ensureChildMenu(growthMenu, 72, "student-honor-panel", "学生荣誉信息", role,
                "ROLE_ADMIN", "ROLE_STUDENT", "ROLE_TEACHER");
        ensureChildMenu(growthMenu, 73, "daily-activity-panel", "日常活动信息", role,
                "ROLE_ADMIN", "ROLE_STUDENT", "ROLE_TEACHER");
    }
